...
export default function VernaShowcase() {
  return (
    <section className="w-full bg-[#f4f4f4] py-12 md:py-20 overflow-hidden relative">
      <div className="max-w-[1920px] mx-auto flex flex-col items-center">
        ...
        <div className="w-full h-[35vh] sm:h-[55vh] md:h-[70vh] lg:h-[80vh] relative flex items-center justify-center mt-0 md:-mt-8 scale-100 md:scale-[1.4] transform origin-center z-10">
